                    ...
                    <div class="menu-header-content btn-pane-right">
                        <div class="avatar-icon-wrapper me-2 avatar-icon-xl">
                            <div class="avatar-icon rounded">
                                ...
                                @else
                                    <img src="{{ asset('images/default-profile.jpeg') }}" alt="{{ $collaborator->name }}">
                                @endif
                            </div>
                        </div>
                        <div>
                        ...
                        <div class="menu-header-btn-pane">
                            <a href="{{ route('collaborators.edit', $collaborator->id) }}" class="ladda-button btn btn-pill btn-light" data-style="slide-right">

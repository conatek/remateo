...
@section('content')
    ...
    <div class="main-card mb-3 card">
        <div class="card-body">
            <form action="{{ route('positions.store') }}" method="post" class="">
                @csrf
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="position-relative mb-3">
                            ...
                            <input name="estimated_salary" id="estimated_salary" value="{{ old('estimated_salary')  }}" placeholder="Ingresar salario estimado" type="text" class="form-control">
                    ...
                    <div class="col-md-6">
                        <div class="position-relative mb-3">
                            ...
                            <textarea name="description" rows="1" class="form-control autosize-input" style="height: 100px;"></textarea>

...
@section('content')
    <div class="app-page-title">
        <div class="page-title-wrapper">
            ...
            <div class="page-title-actions">
                <a href="{{ route('areas.index') }}" type="button" class="btn-shadow me-3 btn btn-info">
    ...
    <div class="main-card mb-3 card">
        <div class="card-body">
            <form action="{{ route('areas.update', $area->id) }}" method="post" class="">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-md-6">
                        <div class="position-relative mb-3">
                            ...
                            <input name="name" id="name" value="{{ old('name', $area->name)  }}" placeholder="Ingresar nombre" type="text" class="form-control" autofocus>
                            @if($errors->has('name'))
